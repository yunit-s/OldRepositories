...
@RequestMapping("sessionAttributesTest03")
public class SessionAttributesController03 {
	...
	public String createString1() {
		log.debug("SessionAttributesController03.createString1() 호출");
		return "createString1";
	}
	
	@ModelAttribute("shin")
	public Student createString2(HttpServletRequest request) {
		log.debug("SessionAttributesController03.createString2() 호출");
